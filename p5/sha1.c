/**
 * Component defining functions for 
 * the SHA1 algorithm
...
/**
 * The first function for the iterations
 * @param b the b value
 * @param c the c value
 * @param d the d value
...
/**
 * The second function for the iterations
 * @param b the b value
 * @param c the c value
 * @param d the d value
 * @return the function return
...
/**
 * The third function for the iterations
 * @param b the b value
 * @param c the c value
 * @param d the d value
 * @return the function return
...
/**
 * The fourth function for the iterations
 * @param b the b value
 * @param c the c value
 * @param d the d value
 * @return the function return
...
/**
 * Bit rotates a unsigned int value by s places
 * @param num the unsigned int
 * @param s the number of places to shift by
 * @param the bit shifted value
 */
...
/**
 * Implements an iterations of the SHA1 algorithm on a 64 byte block.
 * @param data the 64 byte blokc
 * @param a a value of the SHA1 algorithm
 * @param b b value of the SHA1 algorithm
 * @param c c value of the SHA1 algorithm
 * @param d d value of the SHA1 algorithm
 * @param e e value of the SHA1 algorithm
 */
 ...
 * to change the endianess of the bits.
